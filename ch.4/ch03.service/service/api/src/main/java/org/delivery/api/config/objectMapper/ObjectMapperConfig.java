...
public class ObjectMapperConfig {
    ...
    public ObjectMapper objectMapper(){
        ...
        objectMapper.registerModule(new Jdk8Module()); //classes after jdk 8 version

        objectMapper.registerModule(new JavaTimeModule()); //local date

        objectMapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false); //모르는 json field는 무시하고 파싱
